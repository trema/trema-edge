    ...
    describe Configuration do
      ...
      context 'when parsing trema configurations' do
        it 'should remember apps' do
          ...
          Trema::App.add double('app #0', name: 'app #0')
          Trema::App.add double('app #1', name: 'app #1')
          Trema::App.add double('app #2', name: 'app #2')
        ...
        it 'should remember hosts' do
          ...
          Trema::Host.add double('host #0', name: 'host #0')
          Trema::Host.add double('host #1', name: 'host #1')
          Trema::Host.add double('host #2', name: 'host #2')
        ...
        it 'should remember links' do
          ...
          Trema::Link.add double('link #0', name: 'link #0')
          Trema::Link.add double('link #1', name: 'link #1')
          Trema::Link.add double('link #2', name: 'link #2')
        ...
        it 'should remember filter settings' do
          ...
          packetin_filter = double('filter', name: 'filter')
        ...
        it 'should remember switch manager' do
          ...
          switch_manager = double('switch manager', name: 'switch manager')
        ...
        it 'should remember switches' do
          ...
          Trema::OpenflowSwitch.add double('switch #0', name: 'switch #0')
          Trema::OpenflowSwitch.add double('switch #1', name: 'switch #1')
          Trema::OpenflowSwitch.add double('switch #2', name: 'switch #2')
