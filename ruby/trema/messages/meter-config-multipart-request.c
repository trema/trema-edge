...
buffer *
pack_meter_config_multipart_request( VALUE options ) {
  ...
  buffer *meter_config_multipart_request = create_meter_config_multipart_request( xid, flags, meter_id );
  return meter_config_multipart_request;
}
